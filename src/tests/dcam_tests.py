...
class _DepthProfileTestContext:
    ...
    # NOTE: _results_dir, _captured_dir, _metrics_dir, _save_frame, _save_metrics_json
    # have been intentionally removed — no file-saving in this module.
    ...
    # NOTE: _save_failure_artifacts removed — no file-saving in this module.
    ...
    def depth_perception_test(self, simulator) -> Dict[str, Any]:
        ...
        def _update_depth_metrics(status: str, error_reason: str = "") -> None:
        ...
        _update_depth_metrics(status="PASS")
        return {
            "id": "DEPTH",
            "metrics": {
                "distances_m": list(self.TEST_DISTANCES),
